...
export function TelegramJoinCard({
  ...
  return (
    <a
      ...
      rel="noopener noreferrer"
      onClick={onClick}
      className="flex items-center gap-3 rounded-xl border border-[#229ED9]/35 bg-[#229ED9]/10 px-4 py-3 transition-colors active:opacity-80"
    ...
    >
      ...
      <span className="flex min-w-0 flex-col">
        <span className="text-[14px] font-bold text-white">Telegramでセール速報</span>
        <span className="text-[11px] leading-snug text-white/55">
          登録不要・毎日の最大割引をチャンネルで配信
        </span>
      </span>
